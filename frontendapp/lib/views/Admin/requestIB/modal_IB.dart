              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Keterangan               :   ${requestIbView.deskripsi}',
                      style: const TextStyle(fontSize: 15.0),
                    ),
                    const SizedBox(height: 8.0),
                    Text(
                      'Tujuan                       :   ${requestIbView.tujuan}',
                      style: const TextStyle(fontSize: 15.0),
                    ),
                    const SizedBox(height: 8.0),
                    Text(
                      'Tanggal Berangkat  :   ${DateFormat('yyyy-MM-dd HH:mm WIB').format(requestIbView.tanggalBerangkat)}',
                      style: const TextStyle(fontSize: 15.0),
                    ),
                    const SizedBox(height: 8.0),
                    Text(
                      'Tanggal Kembali      :   ${DateFormat('yyyy-MM-dd HH:mm WIB').format(requestIbView.tanggalKembali)}',
                      style: const TextStyle(fontSize: 15.0),
                    ),
                    const SizedBox(height: 8.0),
                    Text(
                      'Status                        :   ${requestIbView.status}',
                      style: const TextStyle(fontSize: 15.0),
                    ),
